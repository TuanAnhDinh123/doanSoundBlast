    ...
    <div class="col-3 row">
        <div class="col-5">
            <p class="likeIconContainer">
                ...
                <span class="likeIconClass"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart"
                    viewBox="0 0 16 16">
                    <path
        ...
        <div class="col-5">
            <p><span>{{$song->numberOfHear}}K</span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
