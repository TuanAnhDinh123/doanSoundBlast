...
const libraryData = [
  {
    ...
    artist: "Nhiều ca sĩ",
    key: "album-china",
    background: "{{asset('uploads/images/01.jpg')}}",
    listMusic: [
      {
        song: "A Moment Of Romance",
        artist: "Viên Phụng Nghi",
        path: "{{asset('uploads/music/01AMomentOfRomance.mp3')}}",
        thumbnail: "{{asset('uploads/images/01.jpg')}}",
      },
      {
        song: "999 Đóa Hồng",
        artist: "Trác Y Đình",
              ...
              .map(
                ...
                <div class='albums__child'>
                      <div class='album__image'>
                            ...
                            <img src=${obj.background} alt="Trulli" style="width:100%">
                      </div>
